...
const projects = [
  ...
  },
  {
    id: 2,
    title: "BLOGING",
    description: "A Blogging App is a web application that allows users to create, edit, publish, and manage blog posts through an intuitive interface.",
    tech: [ "NextJS", "React", "Node js" ],
    github: "#",
    demo: "#",
  }
